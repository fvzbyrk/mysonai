...
describe('Master Prompt System', () => {
  ...
  describe('Agent Boundary Validation', () => {
    test('should detect when agent is asked about forbidden topics', () => {
      const result = validator.validatePrompt('fevzi', 'normal prompt', 'kod yazma konusunda yardım et');
    ...
    test('should allow agent to handle their expertise area', () => {
      const result = validator.validatePrompt('fevzi', 'normal prompt', 'proje yönetimi konusunda yardım et');
