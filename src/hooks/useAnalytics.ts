...
export function useAnalytics() {
  ...
  // Track page view
  const trackPageView = useCallback((data?: Partial<PageViewData>) => {
  ...
  const sendCustomEvent = useCallback(async (event: Omit<AnalyticsEvent, 'timestamp' | 'session_id' | 'page_url' | 'page_title' | 'user_agent' | 'referrer'>) => {
