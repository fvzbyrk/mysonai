...
const blogPosts = [
  {
    ...
    excerpt: 'Yapay zeka teknolojilerindeki son gelişmeler ve AI asistanların iş dünyasındaki rolü hakkında detaylı bir analiz.',
  ...
  },
  {
    ...
    excerpt: 'Türkçe dil desteğinin AI sistemlerindeki kritik rolü ve kullanıcı deneyimine etkileri.',
    author: 'Elif Yılmaz',
    date: '2024-01-10',
    readTime: '4 dk',
  ...
  },
  {
    ...
    excerpt: 'Geleneksel chatbotlar ile gelişmiş AI asistanlar arasındaki farklar ve hangi durumlarda hangisini tercih etmek gerekir.',
    author: 'Burak Demir',
    date: '2024-01-05',
    readTime: '6 dk',
  ...
  },
  {
    ...
    excerpt: 'AI asistanların müşteri hizmetlerinde nasıl devrim yarattığını gösteren gerçek vaka çalışmaları.',
    author: 'Seda Kaya',
    date: '2023-12-28',
    readTime: '7 dk',
  ...
  },
  {
    ...
    excerpt: 'AI sistemlerinde veri güvenliği ve kullanıcı gizliliğinin nasıl sağlanması gerektiği hakkında rehber.',
    author: 'Leyla Özkan',
    date: '2023-12-20',
    readTime: '8 dk',
    category: 'Güvenlik',
  ...
  },
  {
    ...
    excerpt: 'Küçük ve orta ölçekli işletmelerin AI teknolojilerini nasıl etkili şekilde kullanabileceğini anlatan pratik rehber.',
    author: 'Ahmet Yıldız',
    date: '2023-12-15',
    readTime: '5 dk',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                         AI teknolojileri, yapay zeka trendleri ve MySonAI&apos;dan en güncel haberler. 
