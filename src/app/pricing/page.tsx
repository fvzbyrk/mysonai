      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Her ihtiyacınıza uygun esnek fiyatlandırma planları. 
            Ücretsiz başlayın, ihtiyacınız arttıkça ölçeklendirin.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
              ...
              <p className="text-gray-300">
                Evet, istediğiniz zaman planınızı değiştirebilirsiniz. 
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
              ...
              <p className="text-gray-300">
                ...
                İptal sonrası dönem sonuna kadar hizmetlerinizden yararlanmaya devam edersiniz.
              </p>
            </div>
          </div>
        </div>
