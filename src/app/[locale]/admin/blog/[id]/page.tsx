...
export default function BlogPostDetailPage() {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      published: { label: 'Yayınlandı', className: 'bg-green-500/20 text-green-400 border-green-500/50' },
      draft: { label: 'Taslak', className: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/50' },
      scheduled: { label: 'Zamanlanmış', className: 'bg-blue-500/20 text-blue-400 border-blue-500/50' }
    };
