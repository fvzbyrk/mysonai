...
export default function AdvancedUsersPage() {
  ...
  const getRoleBadge = (role: string) => {
    switch (role) {
      ...
      case 'admin':
        return (
          <Badge className='bg-orange-500/20 text-orange-400 border-orange-500/50'>Admin</Badge>
        );
      case 'editor':
      ...
      case 'viewer':
        return (
          <Badge className='bg-gray-500/20 text-gray-400 border-gray-500/50'>Görüntüleyici</Badge>
        );
      default:
        return (
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'locked':
        return (
          <Badge className='bg-orange-500/20 text-orange-400 border-orange-500/50'>Kilitli</Badge>
        );
      case 'banned':
