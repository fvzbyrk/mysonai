                ...
                <div className='flex items-start justify-between'>
                  <div className='flex items-start space-x-4'>
                    <div className='w-12 h-12 bg-purple-500/20 rounded-full flex items-center justify-center'>
                      {React.createElement(getCategoryIcon(integration.category), {
                    ...
                    <div className='flex-1'>
                      ...
                      <div className='flex items-center space-x-6 text-gray-400 text-sm mb-3'>
                        <div className='flex items-center'>
                          <Clock className='w-4 h-4 mr-1' />v{integration.version}
                        </div>
                        <div className='flex items-center'>
                          <Activity className='w-4 h-4 mr-1' />%{integration.successRate} başarı
                        </div>
                        <div className='flex items-center'>
                        ...
                        <div className='flex items-center space-x-2'>
                          ...
                          {integration.permissions.length > 3 && (
                            <span className='text-gray-400 text-xs'>
                              +{integration.permissions.length - 3} daha
                            </span>
                          )}
                        </div>
