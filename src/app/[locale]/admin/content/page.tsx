...
export default function ContentManagementPage() {
  ...
  const getTypeBadge = (type: string) => {
    switch (type) {
      ...
      case 'media':
        return (
          <Badge className='bg-purple-500/20 text-purple-400 border-purple-500/50'>Medya</Badge>
        );
      case 'template':
        return (
          <Badge className='bg-orange-500/20 text-orange-400 border-orange-500/50'>Şablon</Badge>
        );
      default:
        return (
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'archived':
        return (
          <Badge className='bg-gray-500/20 text-gray-400 border-gray-500/50'>Arşivlendi</Badge>
        );
      default:
        return (
          <Badge className='bg-gray-500/20 text-gray-400 border-gray-500/50'>Bilinmiyor</Badge>
