              ...
              <div className='p-6'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-2xl font-bold text-white'>
                      {analytics.overview.avgSessionDuration} dk
                    </p>
                    <div className='flex items-center mt-2'>
                      <ArrowUp className='w-4 h-4 text-green-400 mr-1' />
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-gray-400'>
                      {analytics.performance.serverHealth.responseTime}ms
                    </span>
                  </div>
                  <div className='flex items-center justify-between'>
                    <span className='text-white text-sm'>CPU Kullanımı</span>
                    <span className='text-gray-400'>
                      {analytics.performance.serverHealth.cpuUsage}%
                    </span>
                  </div>
                  <div className='flex items-center justify-between'>
                    <span className='text-white text-sm'>Bellek Kullanımı</span>
                    <span className='text-gray-400'>
                      {analytics.performance.serverHealth.memoryUsage}%
                    </span>
                  </div>
                  <div className='flex items-center justify-between'>
                    <span className='text-white text-sm'>Disk Kullanımı</span>
                    <span className='text-gray-400'>
                      {analytics.performance.serverHealth.diskUsage}%
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className='p-6'>
                ...
                <div className='space-y-4'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-gray-400'>
                      {formatNumber(analytics.performance.apiMetrics.totalRequests)}
                    </span>
                  </div>
                  <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-gray-400'>
                      {analytics.performance.apiMetrics.avgResponseTime}ms
                    </span>
                  </div>
                </div>
              </div>
