...
interface SecurityEvent {
  id: string;
  type: 'login' | 'logout' | 'failed_login' | 'password_change' | 'permission_change' | 'suspicious_activity' | 'data_access' | 'system_change';
...
export default function SecurityPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'investigating':
        return <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/50">İnceleniyor</Badge>;
      case 'pending':
        return <Badge className="bg-yellow-500/20 text-yellow-400 border-yellow-500/50">Beklemede</Badge>;
      case 'ignored':
        return <Badge className="bg-gray-500/20 text-gray-400 border-gray-500/50">Yok Sayıldı</Badge>;
      default:
        return <Badge className="bg-gray-500/20 text-gray-400 border-gray-500/50">Bilinmiyor</Badge>;
    }
  };
  ...
  const getTypeBadge = (type: string) => {
    switch (type) {
      ...
      case 'failed_login':
        return <Badge className="bg-red-500/20 text-red-400 border-red-500/50">Başarısız Giriş</Badge>;
      case 'password_change':
        return <Badge className="bg-yellow-500/20 text-yellow-400 border-yellow-500/50">Şifre Değişikliği</Badge>;
      case 'permission_change':
        return <Badge className="bg-purple-500/20 text-purple-400 border-purple-500/50">Yetki Değişikliği</Badge>;
      case 'suspicious_activity':
        return <Badge className="bg-orange-500/20 text-orange-400 border-orange-500/50">Şüpheli Aktivite</Badge>;
      case 'data_access':
        return <Badge className="bg-cyan-500/20 text-cyan-400 border-cyan-500/50">Veri Erişimi</Badge>;
      case 'system_change':
        return <Badge className="bg-pink-500/20 text-pink-400 border-pink-500/50">Sistem Değişikliği</Badge>;
      default:
        return <Badge className="bg-gray-500/20 text-gray-400 border-gray-500/50">Bilinmiyor</Badge>;
    }
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button 
              className="bg-gradient-to-r from-red-600 to-orange-600 text-white border-0 hover:from-red-700 hover:to-orange-700"
            >
            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">{events.filter(e => e.severity === 'critical' || e.severity === 'high').length}</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="login" className="bg-gray-800">Giriş</option>
                  <option value="logout" className="bg-gray-800">Çıkış</option>
                  <option value="failed_login" className="bg-gray-800">Başarısız Giriş</option>
                  <option value="password_change" className="bg-gray-800">Şifre Değişikliği</option>
                  <option value="suspicious_activity" className="bg-gray-800">Şüpheli Aktivite</option>
                  <option value="data_access" className="bg-gray-800">Veri Erişimi</option>
                  <option value="system_change" className="bg-gray-800">Sistem Değişikliği</option>
                </select>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="ignored" className="bg-gray-800">Yok Sayıldı</option>
                </select>
              </div>
          ...
          <Card className="bg-white/10 backdrop-blur-md border-white/20">
            <div className="p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">
                {searchTerm || selectedType !== 'all' || selectedSeverity !== 'all' || selectedStatus !== 'all' ? 'Güvenlik olayı bulunamadı' : 'Henüz güvenlik olayı yok'}
              </h3>
