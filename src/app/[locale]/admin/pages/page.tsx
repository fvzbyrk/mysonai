                  ...
                  <div className='p-6'>
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='flex items-center justify-between'>
                        ...
                        <span className='text-green-400 font-semibold'>{stats.publishedPages}</span>
                      </div>
                      <div className='flex items-center justify-between'>
                        <span className='text-gray-300'>Taslak</span>
                        <span className='text-yellow-400 font-semibold'>{stats.draftPages}</span>
                      </div>
                      <div className='flex items-center justify-between'>
                        <span className='text-gray-300'>Arşivlendi</span>
                        <span className='text-gray-400 font-semibold'>{stats.archivedPages}</span>
                      </div>
                      <div className='flex items-center justify-between'>
