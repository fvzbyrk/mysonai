...
export default function PerformanceMonitoringPage() {
  ...
  const getServerStatusBadge = (status: string) => {
    switch (status) {
      case 'online':
        return <Badge className="bg-green-500/20 text-green-400 border-green-500/50">Çevrimiçi</Badge>;
      case 'offline':
        return <Badge className="bg-red-500/20 text-red-400 border-red-500/50">Çevrimdışı</Badge>;
      case 'maintenance':
        return <Badge className="bg-yellow-500/20 text-yellow-400 border-yellow-500/50">Bakım</Badge>;
      default:
        return <Badge className="bg-gray-500/20 text-gray-400 border-gray-500/50">Bilinmiyor</Badge>;
    }
  };
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-300">Sistem sağlığı, kaynak kullanımı ve gerçek zamanlı loglar</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <Button 
                ...
                <div key={index} className="bg-white/5 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center space-x-4 text-sm">
                      <span className="text-gray-400">İstekler: <span className="text-white">{api.requests}</span></span>
                      <span className="text-gray-400">Son saat: <span className="text-white">{api.lastHour}</span></span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className={cn(
                        api.successRate > 95 ? "text-green-400" : 
                        api.successRate > 90 ? "text-yellow-400" : "text-red-400"
                      )}>
                        {api.successRate > 95 ? "Sağlıklı" : 
                         api.successRate > 90 ? "Uyarı" : "Kritik"}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <option value="all" className="bg-gray-800">Tüm Seviyeler</option>
