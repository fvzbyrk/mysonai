          ...
          <Card className='bg-white/10 backdrop-blur-md border-white/20'>
            <div className='p-8'>
              ...
              <p className='text-gray-300 leading-relaxed'>
                MySonAI olarak, kişisel verilerinizin güvenliği ve gizliliği bizim için en önemli
                önceliklerden biridir. Bu gizlilik politikası, 6698 sayılı Kişisel Verilerin
                Korunması Kanunu (KVKK) ve Avrupa Birliği Genel Veri Koruma Yönetmeliği (GDPR)
                kapsamında, kişisel verilerinizin nasıl toplandığını, işlendiğini ve korunduğunu
                açıklamaktadır.
              </p>
            </div>
          </Card>
