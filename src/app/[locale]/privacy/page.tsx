          ...
          <div className="space-y-8">
                  ...
                  <div className="space-y-4 text-gray-300">
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4">
                        <li>{isTurkish ? 'E-posta adresi ve şifre' : 'Email address and password'}</li>
                        <li>{isTurkish ? 'Ad ve soyad' : 'First and last name'}</li>
                        <li>{isTurkish ? 'Profil bilgileri' : 'Profile information'}</li>
                        <li>{isTurkish ? 'Ödeme bilgileri (Stripe aracılığıyla)' : 'Payment information (via Stripe)'}</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4">
                        ...
                        <li>{isTurkish ? 'Mesaj sayısı ve token kullanımı' : 'Message count and token usage'}</li>
                        <li>{isTurkish ? 'Sayfa görüntüleme verileri' : 'Page view data'}</li>
                        <li>{isTurkish ? 'Cihaz ve tarayıcı bilgileri' : 'Device and browser information'}</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">
                    {isTurkish ? '2. Verilerinizi Nasıl Kullanıyoruz?' : '2. How Do We Use Your Data?'}
                  </h2>
                  <div className="space-y-4 text-gray-300">
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>{isTurkish ? 'Hizmetlerimizi sağlamak ve geliştirmek' : 'To provide and improve our services'}</li>
                      <li>{isTurkish ? 'Kullanıcı hesaplarını yönetmek' : 'To manage user accounts'}</li>
                      <li>{isTurkish ? 'AI asistan performansını optimize etmek' : 'To optimize AI assistant performance'}</li>
                      <li>{isTurkish ? 'Müşteri desteği sağlamak' : 'To provide customer support'}</li>
                      <li>{isTurkish ? 'Güvenlik ve dolandırıcılık önleme' : 'Security and fraud prevention'}</li>
                      <li>{isTurkish ? 'Yasal yükümlülükleri yerine getirmek' : 'To fulfill legal obligations'}</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">
                    {isTurkish ? '3. Verilerinizi Kimlerle Paylaşıyoruz?' : '3. Who Do We Share Your Data With?'}
                  </h2>
                  <div className="space-y-4 text-gray-300">
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4">
                        <li>{isTurkish ? 'Supabase (veritabanı ve kimlik doğrulama)' : 'Supabase (database and authentication)'}</li>
                        <li>{isTurkish ? 'OpenAI (AI asistan hizmetleri)' : 'OpenAI (AI assistant services)'}</li>
                        <li>{isTurkish ? 'Stripe (ödeme işlemleri)' : 'Stripe (payment processing)'}</li>
                        <li>{isTurkish ? 'Google Analytics (web analitik)' : 'Google Analytics (web analytics)'}</li>
                      </ul>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">
                ...
                <div>
                  ...
                  <div className="space-y-4 text-gray-300">
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      ...
                      <li>{isTurkish ? 'SSL/TLS güvenlik protokolleri' : 'SSL/TLS security protocols'}</li>
                      <li>{isTurkish ? 'Güvenli veri saklama' : 'Secure data storage'}</li>
                      <li>{isTurkish ? 'Düzenli güvenlik denetimleri' : 'Regular security audits'}</li>
                      <li>{isTurkish ? 'Erişim kontrolü ve izleme' : 'Access control and monitoring'}</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-4 text-gray-300">
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>{isTurkish ? 'Verilerinize erişim hakkı' : 'Right to access your data'}</li>
                      <li>{isTurkish ? 'Verilerinizi düzeltme hakkı' : 'Right to correct your data'}</li>
                      <li>{isTurkish ? 'Verilerinizi silme hakkı' : 'Right to delete your data'}</li>
                      <li>{isTurkish ? 'Veri işlemeyi kısıtlama hakkı' : 'Right to restrict data processing'}</li>
                      <li>{isTurkish ? 'Veri taşınabilirliği hakkı' : 'Right to data portability'}</li>
                ...
                <div>
                  ...
                  <div className="space-y-4 text-gray-300">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4">
                        <li>{isTurkish ? 'Gerekli çerezler (site işlevselliği için)' : 'Essential cookies (for site functionality)'}</li>
                        <li>{isTurkish ? 'Analitik çerezler (Google Analytics)' : 'Analytics cookies (Google Analytics)'}</li>
                        <li>{isTurkish ? 'Tercih çerezleri (kullanıcı ayarları)' : 'Preference cookies (user settings)'}</li>
                      </ul>
                    </div>
                  </div>
                </div>
