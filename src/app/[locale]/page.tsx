        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24'>
          <div className='text-center'>
            ...
            <p className='text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8'>
              AI çözümleri ve klasik bilişim hizmetleri sunan teknoloji firması. Geleceği bugün
              şekillendiriyoruz.
            </p>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <div className='bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20'>
            ...
            <p className='text-gray-300 mb-8'>
              AI asistanlarımızı üyelik olmadan deneyimleyin. Herkese açık demo deneyimimizi
              keşfedin!
            </p>
            <Link
              href={`/${params.locale}/demo`}
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='text-gray-300 mb-6'>
              AI çözümleri ve klasik bilişim hizmetleri sunan teknoloji firması
            </p>
