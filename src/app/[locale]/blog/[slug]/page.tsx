    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900'>
      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20'>
        ...
        {recentPosts.length > 0 && (
          <div className='mb-12'>
            <h2 className='text-2xl font-bold text-white mb-6'>İlgili Makaleler</h2>
              ...
              {recentPosts.map(relatedPost => (
                ...
                >
                  <div className='p-6'>
                    ...
                    <p className='text-gray-300 text-sm mb-4 line-clamp-3'>{relatedPost.excerpt}</p>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    <p className='text-gray-300'>
                      Çok faydalı bir makale olmuş. AI teknolojilerinin geleceği hakkında
                      düşüncelerimizi şekillendiriyor.
                    </p>
                  </div>
                </div>
              </div>
