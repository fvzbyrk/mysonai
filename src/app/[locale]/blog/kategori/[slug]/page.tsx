...
function CategoryContent({ params }: { params: { locale: Locale; slug: string } }) {
  const category = blogCategories.find(cat => cat.slug === params.slug);
      ...
      <section className='py-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            <div
              className={`w-20 h-20 bg-gradient-to-r ${category.color} rounded-full flex items-center justify-center mx-auto mb-6`}
            >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>{category.description}</p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          {posts.length > 0 ? (
            ...
            <div className='text-center py-20'>
              ...
              <h2 className='text-2xl font-bold text-white mb-4'>Henüz Makale Yok</h2>
      ...
      <section className='py-16 bg-black/20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            <h2 className='text-3xl font-bold text-white mb-4'>Diğer Kategoriler</h2>
            <p className='text-gray-300'>Diğer ilgi alanlarınızı keşfedin</p>
          </div>
            ...
            {blogCategories
              ...
              .map(otherCategory => (
                <Link
                  ...
                  href={`/${params.locale}/blog/kategori/${otherCategory.slug}`}
                >
                  <Card
                    className={`bg-gradient-to-r ${otherCategory.color} text-white hover:scale-105 transition-all duration-300 cursor-pointer`}
                  >
                    <div className='p-6 text-center'>
                      ...
                      <div className='text-white/60 text-xs'>{otherCategory.postCount} makale</div>
                    </div>
                  </Card>
                </Link>
              ))}
