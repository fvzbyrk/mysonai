          ...
          <div className="space-y-8">
                  ...
                  <div className="space-y-4 text-gray-300">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-4">
                        <li>{isTurkish ? 'Oturum çerezleri (geçici)' : 'Session cookies (temporary)'}</li>
                        <li>{isTurkish ? 'Kalıcı çerezler (uzun süreli)' : 'Persistent cookies (long-term)'}</li>
                        <li>{isTurkish ? 'Birinci taraf çerezleri (bizim)' : 'First-party cookies (ours)'}</li>
                        <li>{isTurkish ? 'Üçüncü taraf çerezleri (partnerlerimiz)' : 'Third-party cookies (our partners)'}</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6 text-gray-300">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-8">
                        <li>{isTurkish ? 'Kimlik doğrulama çerezleri' : 'Authentication cookies'}</li>
                        <li>{isTurkish ? 'Güvenlik çerezleri' : 'Security cookies'}</li>
                        <li>{isTurkish ? 'Dil tercihi çerezleri' : 'Language preference cookies'}</li>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-8">
                        <li>{isTurkish ? 'Google Analytics çerezleri' : 'Google Analytics cookies'}</li>
                        <li>{isTurkish ? 'Sayfa görüntüleme verileri' : 'Page view data'}</li>
                        <li>{isTurkish ? 'Kullanıcı davranış analizi' : 'User behavior analysis'}</li>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">
                    {isTurkish ? '3. Çerez Ayarlarınızı Nasıl Yönetirsiniz?' : '3. How Do You Manage Your Cookie Settings?'}
                  </h2>
                  <div className="space-y-4 text-gray-300">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-8">
                        <li>{isTurkish ? 'Chrome: Ayarlar > Gizlilik ve güvenlik > Çerezler' : 'Chrome: Settings > Privacy and security > Cookies'}</li>
                        <li>{isTurkish ? 'Firefox: Seçenekler > Gizlilik ve güvenlik' : 'Firefox: Options > Privacy and security'}</li>
                        <li>{isTurkish ? 'Safari: Tercihler > Gizlilik' : 'Safari: Preferences > Privacy'}</li>
                        <li>{isTurkish ? 'Edge: Ayarlar > Çerezler ve site izinleri' : 'Edge: Settings > Cookies and site permissions'}</li>
                      </ul>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-4 text-gray-300">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 ml-8">
                        <li>{isTurkish ? '_ga: Kullanıcıları ayırt etmek için' : '_ga: To distinguish users'}</li>
                        <li>{isTurkish ? '_gid: Kullanıcıları ayırt etmek için' : '_gid: To distinguish users'}</li>
                        <li>{isTurkish ? '_gat: İstek hızını sınırlamak için' : '_gat: To throttle request rate'}</li>
                      </ul>
                    </div>
                      ...
                      <table className="w-full border-collapse">
                        ...
                        <tbody className="text-sm">
                          <tr className="border-b border-gray-700">
                            ...
                            <td className="py-2 px-4">{isTurkish ? 'Tarayıcı kapatılana kadar' : 'Until browser closed'}</td>
                            <td className="py-2 px-4">{isTurkish ? 'Temel işlevsellik' : 'Basic functionality'}</td>
                          </tr>
                          <tr className="border-b border-gray-700">
                            <td className="py-2 px-4">Authentication</td>
                            <td className="py-2 px-4">30 gün</td>
                            <td className="py-2 px-4">{isTurkish ? 'Kullanıcı oturumu' : 'User session'}</td>
                          </tr>
                          <tr className="border-b border-gray-700">
                            <td className="py-2 px-4">Analytics</td>
                            <td className="py-2 px-4">2 yıl</td>
                            <td className="py-2 px-4">{isTurkish ? 'Web analitik' : 'Web analytics'}</td>
                          </tr>
                          <tr className="border-b border-gray-700">
                            <td className="py-2 px-4">Preferences</td>
                            <td className="py-2 px-4">1 yıl</td>
                            <td className="py-2 px-4">{isTurkish ? 'Kullanıcı tercihleri' : 'User preferences'}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
            ...
            <Card className="bg-white/10 backdrop-blur-md border-white/20 p-8">
              <div className="text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white">
                    <strong>{isTurkish ? 'Sonraki gözden geçirme:' : 'Next review:'}</strong> 15 Temmuz 2024
                  </p>
                </div>
              </div>
            </Card>
