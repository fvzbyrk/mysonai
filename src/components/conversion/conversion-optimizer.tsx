...
export function ConversionOptimizer({
  ...
  const mockData = {
    ...
    funnelSteps: [
      ...
      { name: 'Demo Sayfası', visitors: 800, conversions: 400, conversionRate: 50, dropOffRate: 50 },
    ...
    ctaPerformance: [
      { text: 'Ücretsiz Deneyin', clicks: 1234, conversions: 156, conversionRate: 12.6, revenue: 30420 },
      { text: 'Hemen Başlayın', clicks: 892, conversions: 98, conversionRate: 11.0, revenue: 19110 },
  ...
  const getConversionLevel = (rate: number) => {
    if (rate >= 10) return { level: 'Mükemmel', color: 'text-green-500', bg: 'bg-green-500/20' };
    if (rate >= 5) return { level: 'İyi', color: 'text-yellow-500', bg: 'bg-yellow-500/20' };
    if (rate >= 2) return { level: 'Orta', color: 'text-orange-500', bg: 'bg-orange-500/20' };
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                {mockData.insights.map((insight, index) => (
                  <div key={index} className="flex items-start p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                {mockData.recommendations.map((recommendation, index) => (
                  <div key={index} className="flex items-start p-3 bg-green-500/10 rounded-lg border border-green-500/20">
