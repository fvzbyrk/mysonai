    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {usage.totalMessages} / {usage.monthlyLimit.messages === -1 ? '∞' : usage.monthlyLimit.messages}
            </span>
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          <div
            className={`h-2 rounded-full transition-all duration-300 ${
              usage.monthlyLimit.messages === -1 ? 'bg-green-500' : 'bg-gradient-to-r from-purple-500 to-pink-500'
            }`}
            style={{
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {usage.totalTokens.toLocaleString()} / {usage.monthlyLimit.tokens === -1 ? '∞' : usage.monthlyLimit.tokens.toLocaleString()}
            </span>
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          <div
            className={`h-2 rounded-full transition-all duration-300 ${
              usage.monthlyLimit.tokens === -1 ? 'bg-green-500' : 'bg-gradient-to-r from-blue-500 to-cyan-500'
            }`}
            style={{
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {usage.totalImages} / {usage.monthlyLimit.images === -1 ? '∞' : usage.monthlyLimit.images}
            </span>
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          <div
            className={`h-2 rounded-full transition-all duration-300 ${
              usage.monthlyLimit.images === -1 ? 'bg-green-500' : 'bg-gradient-to-r from-green-500 to-emerald-500'
            }`}
            style={{
