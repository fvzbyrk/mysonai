      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            Geleceği Bugün
            <span className="block gradient-text">Keşfedin</span>
          </h2>
          
          <p className="text-xl md:text-2xl text-purple-100 mb-8 max-w-3xl mx-auto">
            MySonAI ile yapay zeka teknolojilerinin gücünü deneyimleyin. 
            <span className="text-white font-semibold"> Hemen başlayın</span> ve projelerinizi bir üst seviyeye taşıyın.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button asChild variant="outline" size="lg" className="border-white/30 text-white hover:bg-white/10 px-8 py-4 text-lg font-semibold">
              <Link href="/contact">
                Demo İste
              </Link>
            </Button>
