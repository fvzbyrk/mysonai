...
import { Text, Plus, Minus, Contrast, Volume2, VolumeX, Settings, X } from 'lucide-react';
import { cn } from '@/lib/utils';

export function AccessibilityToolbar() {
  const { fontSize, isHighContrast, increaseFontSize, decreaseFontSize, resetFontSize, announce } =
