  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: 'assistant',
      content:
        'Merhaba! Ben MySonAI asistanınızım. Size nasıl yardımcı olabilirim? Projeniz hakkında sorularınızı sorabilir, hizmetlerimiz hakkında bilgi alabilir veya teknik destek isteyebilirsiniz.',
      timestamp: new Date(),
    },
  ]);
