...
export function AnalyticsDashboard({
  ...
  const getEngagementLevel = (score: number) => {
    if (score >= 70) {
      return { level: 'Yüksek', color: 'text-green-500', bg: 'bg-green-500/20' };
    }
    if (score >= 40) {
      return { level: 'Orta', color: 'text-yellow-500', bg: 'bg-yellow-500/20' };
    }
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        ...
        <Card className='bg-white/10 backdrop-blur-md border-white/20'>
          <div className='p-6'>
            ...
            <h3 className='text-2xl font-bold text-white mb-1'>{mockData.bounceRate}%</h3>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <Card className='bg-white/10 backdrop-blur-md border-white/20'>
          <div className='p-6'>
            ...
            <div className='flex items-center justify-between mb-4'>
              <div className='text-3xl font-bold text-white'>{mockData.performanceScore}</div>
                ...
                <div className='flex items-center'>
                  <div className='w-24 bg-gray-700 rounded-full h-2 mr-2'>
                    <div
                      ...
                      style={{ width: `${mockData.userEngagement.high}%` }}
                    />
                  </div>
                ...
                <div className='flex items-center'>
                  <div className='w-24 bg-gray-700 rounded-full h-2 mr-2'>
                    <div
                      ...
                      style={{ width: `${mockData.userEngagement.medium}%` }}
                    />
                  </div>
                  <span className='text-white font-semibold'>
                    {mockData.userEngagement.medium}%
                  </span>
                </div>
              </div>
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center'>
                  <div className='w-24 bg-gray-700 rounded-full h-2 mr-2'>
                    <div
                      ...
                      style={{ width: `${mockData.userEngagement.low}%` }}
                    />
                  </div>
