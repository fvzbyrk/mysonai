          ...
          <CardTitle className="flex items-center justify-between">
            ...
            {subscription && (
              <Badge 
                ...
                className={subscription.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}
              >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold">{getPlanInfo(subscription?.plan || 'free').name}</h3>
                    <p className="text-sm text-gray-500">
                      {subscription?.plan === 'free' ? 'Ücretsiz' : `${getPlanInfo(subscription?.plan || 'free').price / 100}₺/ay`}
                    </p>
                  </div>
                </div>
              </div>
