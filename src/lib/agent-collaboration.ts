...
export const AGENT_TEAMS: AgentTeam[] = [
  {
    ...
    triggerKeywords: [
      'diyet', 'beslenme', 'spor', 'fitness', 'egzersiz', 'kilo', 'zayıflama', 
      'kas', 'antrenman', 'beslenme programı', 'spor programı', 'sağlıklı yaşam',
      'vücut geliştirme', 'kardiyo', 'güç antrenmanı', 'beslenme planı'
    ],
  ...
  },
  {
    ...
    triggerKeywords: [
      'şirket kurma', 'iş kurma', 'yatırım', 'hukuki', 'finansal', 'bütçe',
      'sözleşme', 'vergi', 'muhasebe', 'hukuki danışmanlık', 'finansal planlama',
      'iş planı', 'yatırım analizi', 'hukuki risk', 'finansal risk'
    ],
    useCase: 'İş kurma, yatırım veya finansal planlama konularında hem hukuki hem finansal danışmanlık gerektiğinde',
  ...
  },
  {
    ...
    collaborationType: 'integrated',
    triggerKeywords: [
      'öğrenme', 'eğitim', 'psikoloji', 'motivasyon', 'konsantrasyon', 'stres',
      'sınav', 'ders', 'öğrenci', 'başarı', 'performans', 'öğrenme güçlüğü',
      'dikkat', 'hafıza', 'öğrenme stratejisi', 'psikolojik destek'
    ],
  ...
  },
  {
    ...
    triggerKeywords: [
      'proje', 'ürün', 'strateji', 'planlama', 'geliştirme', 'pazar',
      'ürün stratejisi', 'proje yönetimi', 'iş planı', 'pazar analizi',
      'ürün geliştirme', 'proje planlaması', 'stratejik planlama'
    ],
  ...
  },
  {
    ...
    collaborationType: 'consultative',
    triggerKeywords: [
      'yazılım', 'geliştirme', 'mimari', 'kod', 'programlama', 'sistem',
      'teknoloji', 'altyapı', 'güvenlik', 'api', 'frontend', 'backend',
      'yazılım mimarisi', 'sistem tasarımı', 'kod geliştirme'
    ],
  ...
  },
  {
    ...
    collaborationType: 'integrated',
    triggerKeywords: [
      'pazarlama', 'seo', 'e-ticaret', 'dijital', 'satış', 'arama',
      'online', 'pazarlama stratejisi', 'seo stratejisi', 'dijital pazarlama',
      'e-ticaret stratejisi', 'arama motoru', 'pazarlama kampanyası'
    ],
  ...
  },
  {
    ...
    triggerKeywords: [
      'tasarım', 'grafik', 'müzik', 'sanat', 'kreatif', 'görsel',
      'logo', 'marka', 'sanat', 'müzik', 'kreatif proje', 'görsel tasarım',
      'sanat projesi', 'müzik projesi', 'kreatif strateji'
    ],
  ...
  },
  {
    ...
    collaborationType: 'integrated',
    triggerKeywords: [
      'yaşam', 'wellness', 'psikoloji', 'motivasyon', 'kişisel gelişim',
      'yaşam koçluğu', 'psikolojik destek', 'kişisel dönüşüm', 'wellness',
      'yaşam kalitesi', 'psikolojik sağlık', 'kişisel gelişim planı'
    ],
    useCase: 'Kişisel gelişim ve yaşam kalitesi konularında hem koçluk hem psikolojik destek gerektiğinde',
...
export function getCollaborationDescription(type: CollaborationType): string {
  const descriptions = {
    sequential: 'Sıralı İşbirliği: Ajanlar sırayla çalışır, her biri kendi uzmanlık alanında katkı sağlar',
    parallel: 'Paralel İşbirliği: Ajanlar aynı anda çalışır, farklı açılardan yaklaşır',
    consultative: 'Danışmanlık İşbirliği: Ana ajan çalışır, diğer ajanlar danışman olarak katkı sağlar',
